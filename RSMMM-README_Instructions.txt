...
==============================================================
 ...
 KSP:       All versions supported by Soundtrack Editor
   ...
   Thread:    https://forum.kerbalspaceprogram.com/index.php?/topic/59682 !!!!!!!!!!!!!
   Source:    https://github.com/RedStapler55/RSMusicMeloMod
   License:   Attribution 4.0 International (CC BY 4.0) https://creativecommons.org/licenses/by/4.0/ (located in Licenses/RSMMM-Licenses.txt)
   
==============================================================
Description: 

RSMMM adds several stockalike music tracks by Kevin MacLeod and ambient sounds from freesound.org in order to further enhance and add a bit of groovy grooves to your Kerbal Space Program experience. All tracks are instrumental, some are whimsical, some are loungy...all approved by the Kerbin Instrumental Sound Society (aka KISS - not to be confused with the Earthling band).
